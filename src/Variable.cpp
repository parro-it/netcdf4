...
namespace netcdf4js {
    ...
    void Variable::Init(v8::Local<v8::Object> exports) {
        ...
        tpl->InstanceTemplate()->SetAccessor(v8::String::NewFromUtf8(isolate, "compressionshuffle"), Variable::GetCompressionShuffle, Variable::SetCompressionShuffle);
        tpl->InstanceTemplate()->SetAccessor(v8::String::NewFromUtf8(isolate, "compressiondeflate"), Variable::GetCompressionDeflate, Variable::SetCompressionDeflate);
